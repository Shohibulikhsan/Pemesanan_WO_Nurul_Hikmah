...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../assets/css/stylehome_p.css"/> 
...
<section class="navbar navbar-light">
			...
			<div class="navbar-header" >
				...
				<a class="navbar-brand" href="home.php?page=beranda" style="color:#1167b0; padding-left: 55px;">Nurul Hikmah</a>
				<?php
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav">
					<li><a href="home.php?page=beranda" style="color: grey;">Beranda</a></li>
					<li><a href="home.php?page=pemesanan"  style="color: grey;">Pemesanan</a></li>
					<li><a href="home.php?page=kontak"  style="color: grey;">Kritik dan Saran</a></li>
					<li><a href="home.php?page=galery"  style="color: grey;">Galery</a></li>
				</ul>
			</div>
				<?php
					switch ($_GET['page']) {
