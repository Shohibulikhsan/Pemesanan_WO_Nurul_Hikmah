...
?>
		<h3>Pemesanan Satuan</h3>
			<div class="form-pemesanan">
				<form action="../cetakpelanggansatuan.php" method="post" class="p_satuan">
					<?php 
						$query=mysqli_query($koneksi,"SELECT * FROM pengguna INNER JOIN level on pengguna.id_level=level.id_level WHERE username = '$username'");
						$data=mysqli_fetch_array($query);
					?>
					...
					<div class="part">
						...
						<p>harga 1 set =</p>
						<input type="number" placeholder="Masukan Jumlah" name="tenda4x4"  value="0" id="tenda4x4">
					</div>
					<div class="part">
						<?php
					...
					<div class="part">
						...
						<p>harga 1 set =</p>
						<input type="number" placeholder="Masukan Jumlah" name="tenda8x8"  value="0" id="tenda8x8">
					</div>
					<div class="part">
						<?php
					...
					<div class="part">
						...
						<p>harga 1 set =</p>
						<input type="number" placeholder="Masukan Jumlah" name="tendasisir" value="0" id="tendasisir">
					</div>
					<div class="part">
						<?php
					...
					<div class="part">
						...
						<input type="submit" class="btn btn-primary" value="Submit">
						<a href="home.php?page=pemesanan" style="padding-left: 330px;">sewa tenda paket</a>
